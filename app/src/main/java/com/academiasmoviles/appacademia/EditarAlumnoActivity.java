...
public class EditarAlumnoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Passing data: Obtenemos los datos
        mostrarDatos();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_activity_editar_alumno, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.accion_grabar:
                ...
                mostrarDialogo("Confirmación", "¿Seguro de editar el alumno?");

                return true;

            case R.id.accion_eliminar:

                mostrarMensaje("Acción eliminar");

                mostrarDialogoEliminar("Confirmación", "¿Seguro de eliminar el alumno?");
    ...
    private void mostrarDatos()
    {
        ...
        String nombres = intent.getExtras().getString("NOMBRES");
        String apellidos = intent.getExtras().getString("APELLIDOS");
        String foto = intent.getExtras().getString("FOTO");
        String email = intent.getExtras().getString("EMAIL");
        String direccion = intent.getExtras().getString("DIRECCION");
        ...
        edt_apellidos.setText(apellidos);
        edt_foto.setText(foto);
        edt_email.setText(email);
        edt_direccion.setText(direccion);
        edt_latitud.setText(latitud);
        edt_longitud.setText(longitud);
    }
    ...
    public void updateRetrofitAlumno()
    {
        ...
        Call<Alumno> call = request.updateAlumno(id, alumno);

        call.enqueue(new Callback<Alumno>() {
            @Override
            public void onResponse(Call<Alumno> call, Response<Alumno> response) {

                Log.i("RETROFIT", "Termino PUT");
    ...
    public void deleteRetrofitAlumno()
    {
        String id = edt_id.getText().toString();
        ...
        Call<Alumno> call = request.deleteAlumno(id);

        call.enqueue(new Callback<Alumno>() {
            @Override
            public void onResponse(Call<Alumno> call, Response<Alumno> response) {

                Log.i("RETROFIT", "Termino DELETE");
    ...
    private void mostrarDialogoEliminar(String titulo, String mensaje)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        ...
        builder.setMessage(mensaje)
                ...
                .setPositiveButton("Aceptar", new DialogInterface.OnClickListener()  {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        mostrarAlerta("Eliminar Alumno", "El alumno ha sido eliminado con éxito.");

                        deleteRetrofitAlumno();
                    }
                })
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
